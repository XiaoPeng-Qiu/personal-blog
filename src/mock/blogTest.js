...
var data1 = {
  ...
  fetch(<span class="hljs-string">"http://crossdomain.com/api/user"</span>, {
    ...
    <span class="hljs-attr">body</span>: <span class="hljs-built_in">JSON</span>.stringify({ <span class="hljs-attr">name</span>: <span class="hljs-string">"小尤"</span>, <span class="hljs-attr">age</span>: <span class="hljs-number">18</span> }) <span class="hljs-comment">// 设置请求体</span>
  });</code></pre>
  ...
  {"name": "小马", "age": 18 }</code></pre><ol start="4">
